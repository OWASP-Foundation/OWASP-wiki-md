...
## Open Source or Free Tools Of This Type
  ...
  - [RIPS](http://rips-scanner.sourceforge.net/) - RIPS is a static
    source code analyzer for vulnerabilities in PHP web applications.
    Please see notes on the sourceforge.net site.
...
## Commercial Tools Of This Type
  ...
  - [CxSAST](https://www.checkmarx.com/technology/static-code-analysis-sca/)
    (Checkmarx)
  - [Fortify](http://www8.hp.com/us/en/software-solutions/static-code-analysis-sast/)
  ...
  - [RIPS Code Analysis](https://www.ripstech.com/) (RIPS Technologies)
    - A SAST solution specialized for PHP that detects unknown security
  ...
  - [Veracode Static
    ...
    (Veracode)
  - [Xanitizer](http://www.xanitizer.net) - Scans Java for security
    vulnerabilities, mainly via taint analysis. Free for academic and
